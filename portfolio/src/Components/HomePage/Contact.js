...
function Contact() {
  ...
  return (
    <div className="mainsection-wrapper">
        ...
        <div >
          <p className="mainsection-heading__sm attribute pd-bottom">Vector images created by <a href="https://www.freepik.com/free-photos-vectors" className="mainsection-heading__sm link" target="_blank">Freepik</a></p>
        </div>
    </div>
  );
}
